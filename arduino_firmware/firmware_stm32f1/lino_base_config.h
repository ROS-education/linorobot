...
#define COUNTS_PER_REV 3960       // wheel encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.085       // wheel's diameter in meters
#define LR_WHEELS_DISTANCE 0.225  // distance between left and right wheels
...
#define MOTOR3_ENCODER_A 999
#define MOTOR3_ENCODER_B 999 

#define MOTOR4_ENCODER_A 999
#define MOTOR4_ENCODER_B 999
...
//MOTOR PINS
  ...
  #define MOTOR3_PWM 999
  #define MOTOR3_IN_A 999
  #define MOTOR3_IN_B 999

  #define MOTOR4_PWM 999
  #define MOTOR4_IN_A 999
  #define MOTOR4_IN_B 999
